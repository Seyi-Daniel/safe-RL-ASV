...
class ContinuousActor(nn.Module):
    ...
    def __init__(self, in_dim: int = 6, hidden_dim: int = 256, action_dim: int = ACTION_DIM):
        super().__init__()
...
class ContinuousCritic(nn.Module):
    ...
    def __init__(self, in_dim: int = 6, action_dim: int = ACTION_DIM, hidden_dim: int = 256):
        super().__init__()
